const Service = () => {
    return (
        <section id="service" className="section creative-section">
            ...
            <div className="container" style={{ position: 'relative', zIndex: 2 }}>
                ...
                <div className="vision-mission-grid" style={{ marginBottom: 'var(--space-xxl)', gap: '4rem' }}>
                    ...
                    <div className="creative-card vision-card">
                        ...
                        <h3 className="creative-title">Academic Programs</h3>
                        <ul style={{ color: 'var(--clr-neutral-800)', fontSize: '1.05rem', paddingLeft: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', lineHeight: '1.8' }}>
                    ...
                    <div className="creative-card mission-card">
                        ...
                        <h3 className="creative-title">Personalized Learning</h3>
                        <ul style={{ color: 'var(--clr-neutral-800)', fontSize: '1.05rem', paddingLeft: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', lineHeight: '1.8' }}>
                    ...
                    <div className="creative-card vision-card">
                        ...
                        <h3 className="creative-title">Academic Support</h3>
                        <ul style={{ color: 'var(--clr-neutral-800)', fontSize: '1.05rem', paddingLeft: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', lineHeight: '1.8' }}>
                    ...
                    <div className="creative-card mission-card">
                        ...
                        <h3 className="creative-title">College & Career Prep</h3>
                        <ul style={{ color: 'var(--clr-neutral-800)', fontSize: '1.05rem', paddingLeft: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', lineHeight: '1.8' }}>
                    ...
                    <div className="creative-card vision-card">
                        ...
                        <h3 className="creative-title">Extracurriculars</h3>
                        <ul style={{ color: 'var(--clr-neutral-800)', fontSize: '1.05rem', paddingLeft: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', lineHeight: '1.8' }}>
                    ...
                    <div className="creative-card mission-card">
                        ...
                        <h3 className="creative-title">Community Engagement</h3>
                        <ul style={{ color: 'var(--clr-neutral-800)', fontSize: '1.05rem', paddingLeft: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', lineHeight: '1.8' }}>
                ...
                <div className="glass-testimonial" style={{ marginTop: 'var(--space-xxl)' }}>
                    <span className="quote-mark">"</span>
                    <h2 className="section-title text-center" style={{ marginBottom: '2.5rem', display: 'block' }}>Message from the Director</h2>
                    
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', color: 'var(--clr-neutral-800)', fontSize: '1.05rem', lineHeight: '1.8', position: 'relative', zIndex: 2 }}>
                        <p>Dear Parents, Guardians, Teachers, Staff, Students, and Well-wishers,</p>
                        <p>I am delighted to extend my heartfelt greetings to each one of you as we come together on the platform of DPS Kayakuchi.</p>
                        ...
                        <p>Thank you for your continued support and trust in DPS Kayakuchi.</p>
                        <div style={{ marginTop: '2rem', borderTop: '1px solid rgba(0,0,0,0.1)', paddingTop: '1.5rem', textAlign: 'right' }}>
                            <p style={{ margin: 0, fontStyle: 'italic' }}>Best Regards,</p>
                            <p style={{ margin: 0, fontWeight: '800', color: 'var(--clr-primary-500)', fontSize: '1.2rem' }}>DPS Kayakuchi</p>
                            <p style={{ margin: 0, fontSize: '0.9rem', color: 'var(--clr-neutral-800)', textTransform: 'uppercase', letterSpacing: '1px' }}>Director</p>
                        </div>
                    </div>
                </div>
